...
const Product = () => {
    ...
    return<>
        ...
        <View style={[styles.card, { backgroundColor: "#9CE5CB" , marginTop:70, height:400}]}>
                    <Image style={{ position: "absolute", top: 7, right: 0, width: 150, height: 200 }} source={require("./pot.png")} />

                    <Text style={styles.texthead}> Air purifier</Text>
                    <Text style={[styles.textmain, { fontSize: 25 }]} >pepromia</Text>
                    <View style={{ display: "flex", flexDirection: "row" }}>
