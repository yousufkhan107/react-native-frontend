...
const Product5 = () => {
    ...
    return<>
        ...
        <View style={[styles.card, { backgroundColor: "#F5EDA8" , marginTop:70, height:400}]}>
                    <Image style={{ position: "absolute", top: 7, right: 0, width: 150, height: 200 }} source={require("./Layer27.png")} />

                    <Text style={styles.texthead}> Air purifier</Text>
                    <Text style={[styles.textmain, { fontSize: 25 }]} >aloe vera</Text>
                    <View style={{ display: "flex", flexDirection: "row" }}>
